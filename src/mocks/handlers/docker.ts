...
export const dockerHandlers = [
  ...
  http.delete(`${API}/api/v2/nodes/:nodeId/docker/containers/:containerId`, ({ params }) => {
  ...
  http.post(`${API}/api/v2/nodes/:nodeId/docker/containers/prune`, () => {
    return HttpResponse.json({ containers_deleted: [], space_reclaimed: '0B' })
  }),

  http.get(`${API}/api/v2/nodes/:nodeId/docker/containers/:containerId/top`, () => {
  ...
  http.post(`${API}/api/v2/nodes/:nodeId/docker/containers/:containerId/exec`, async () => {
    return HttpResponse.json({ stdout: 'command executed successfully\n', stderr: '', exit_code: 0 })
  }),

  http.get(`${API}/api/v2/nodes/:nodeId/docker/containers/:containerId/logs`, () => {
  ...
  http.post(`${API}/api/v2/nodes/:nodeId/docker/images/build`, async () => {
    return HttpResponse.json({ image_id: 'sha256:build123', tag: 'custom:latest', output: 'Building...\nDone' }, { status: 200 })
  }),

  http.get(`${API}/api/v2/nodes/:nodeId/docker/images/:imageId`, ({ params }) => {
  ...
  http.delete(`${API}/api/v2/nodes/:nodeId/docker/images/:imageId`, () => {
    return new HttpResponse(null, { status: 204 })
  }),

  http.post(`${API}/api/v2/nodes/:nodeId/docker/images/:imageId/tag`, async ({ request }) => {
  ...
  http.delete(`${API}/api/v2/nodes/:nodeId/docker/networks/:networkId`, ({ params }) => {
    const idx = mockNetworks.findIndex((n) => n.ID === params.networkId)
    if (idx !== -1) mockNetworks.splice(idx, 1)
    return new HttpResponse(null, { status: 204 })
  }),

  http.get(`${API}/api/v2/nodes/:nodeId/docker/networks/:networkId`, ({ params }) => {
  ...
  http.post(`${API}/api/v2/nodes/:nodeId/docker/networks/:networkId/connect`, async () => {
    return HttpResponse.json({ message: 'Container connected to network' })
  }),

  http.post(`${API}/api/v2/nodes/:nodeId/docker/networks/:networkId/disconnect`, async () => {
  ...
  http.delete(`${API}/api/v2/nodes/:nodeId/docker/volumes/:volumeName`, ({ params }) => {
    const idx = mockVolumes.findIndex((v) => v.Name === params.volumeName)
    if (idx !== -1) mockVolumes.splice(idx, 1)
    return new HttpResponse(null, { status: 204 })
  }),

  http.get(`${API}/api/v2/nodes/:nodeId/docker/volumes/:volumeName`, ({ params }) => {
  ...
  http.get(`${API}/api/v2/nodes/:nodeId/docker/system/df`, () => {
    return HttpResponse.json([
  ...
  http.post(`${API}/api/v2/docker/bulk/exec`, async ({ request }) => {
  ...
  http.post(`${API}/api/v2/docker/bulk/restart`, async ({ request }) => {
  ...
  http.post(`${API}/api/v2/docker/bulk/start`, async ({ request }) => {
    const body = await request.json() as { node_ids?: string[]; node_tags?: string[] }
    const nodeIds = body.node_ids || ['1', '2']
    return HttpResponse.json({
      action: 'start',
  ...
  http.post(`${API}/api/v2/docker/bulk/stop`, async ({ request }) => {
    const body = await request.json() as { node_ids?: string[]; node_tags?: string[] }
    const nodeIds = body.node_ids || ['1', '2']
    return HttpResponse.json({
      action: 'stop',
  ...
  http.post(`${API}/api/v2/docker/bulk/remove`, async ({ request }) => {
    const body = await request.json() as { node_ids?: string[]; node_tags?: string[] }
    const nodeIds = body.node_ids || ['1', '2']
    return HttpResponse.json({
      action: 'remove',
  ...
  http.post(`${API}/api/v2/docker/bulk/inspect`, async ({ request }) => {
    const body = await request.json() as { node_ids?: string[]; node_tags?: string[] }
    const nodeIds = body.node_ids || ['1', '2']
    return HttpResponse.json({
      action: 'inspect',
  ...
  http.post(`${API}/api/v2/docker/bulk/logs`, async ({ request }) => {
    const body = await request.json() as { node_ids?: string[]; node_tags?: string[] }
    const nodeIds = body.node_ids || ['1', '2']
    return HttpResponse.json({
      action: 'logs',
  ...
  http.post(`${API}/api/v2/docker/bulk/stats`, async ({ request }) => {
    const body = await request.json() as { node_ids?: string[]; node_tags?: string[] }
    const nodeIds = body.node_ids || ['1', '2']
    return HttpResponse.json({
      action: 'stats',
  ...
  http.post(`${API}/api/v2/docker/bulk/images/build`, async ({ request }) => {
  ...
  http.post(`${API}/api/v2/docker/bulk/images/remove`, async ({ request }) => {
  ...
  http.post(`${API}/api/v2/docker/bulk/pull`, async ({ request }) => {
